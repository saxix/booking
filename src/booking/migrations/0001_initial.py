# Generated by Django 4.2.17 on 2024-12-18 19:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "property",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="feedbacks", to="booking.car"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "property",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="bookings", to="booking.car"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ("start_date", models.F("end_date")), ("start_date__gt", models.F("end_date")), _negated=True
                ),
